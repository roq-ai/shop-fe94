  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Discover the new way to business with Shop - your ultimate platform for building a unique and successful webshop."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1652862938332-815e45390b3c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHx3ZWJzaG9wfGVufDB8fHx8MTY5NDUyNzU4OHww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Discover the new way to business with Shop - your ultimate platform for building a unique and successful webshop.`}
            </Text>
            <Box
